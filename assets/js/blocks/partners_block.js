$(document).ready(function(){
    ...
    var clonedDivs1 = $(".partnersBlock .slider .slide").clone().removeClass("first last");
    var clonedDivs2 = $(".partnersBlock .slider .slide").clone().removeClass("first last");
    var clonedDivs3 = $(".partnersBlock .slider .slide").clone().removeClass("first last");
    var clonedDivs4 = $(".partnersBlock .slider .slide").clone().removeClass("first last");
    var clonedDivs5 = $(".partnersBlock .slider .slide").clone().removeClass("first last");
    var clonedDivs6 = $(".partnersBlock .slider .slide").clone().removeClass("first last");
    $(clonedDivs1).insertAfter(".partnersBlock .slider .slide:last");
    $(clonedDivs2).insertAfter(".partnersBlock .slider .slide:last");
    $(clonedDivs3).insertAfter(".partnersBlock .slider .slide:last");
    $(clonedDivs4).insertBefore(".partnersBlock .slider .slide:first");
    $(clonedDivs5).insertBefore(".partnersBlock .slider .slide:first");
    $(clonedDivs6).insertBefore(".partnersBlock .slider .slide:first");
    initializeSlider();
